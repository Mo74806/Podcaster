    ...
    <>
      <div className="generate_thumbnail">
        <Button
          ...
          className={cn('', {
            'bg-black-6 w-full': isAiThumbnail,
          })}
        >
      ...
      {isAiThumbnail ? (
        <div className="flex flex-col gap-5">
          ...
          <div className="w-full text-center">
            <Button type="submit" className="text-16  w-full lg:max-w-[200px] bg-orange-1 py-4 font-bold text-white-1" onClick={generateImage}>
              {isImageLoading ? (
                <>
                  Generating
